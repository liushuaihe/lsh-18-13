...
import { MOCK_DEVICES, MOCK_SENSORS, MOCK_BATCHES } from '../data/mockData';
import {
  canDeviceStart,
  getDependencyOrder,
...
interface MonitorStore {
  ...
  acceptBatch: (batchId: string, inspector: string, remark?: string) => void;
  rejectBatch: (batchId: string, inspector: string, remark?: string) => void;
  updateBatchStatus: (batchId: string, status: BatchStatus, inspector?: string, remark?: string) => void;
}
